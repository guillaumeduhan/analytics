...
function GlobeIcon({ className }: { className?: string }) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" className={className} style={{ color: '#3b82f6' }}>
...
function EdgeIcon({ className }: { className?: string }) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 256 256" className={className}>
      <defs>
        <radialGradient id="edge-a" cx="161.83" cy="788.401" r="95.38" gradientTransform="matrix(.9999 0 0 .9498 -4.622 -570.387)" gradientUnits="userSpaceOnUse"><stop offset=".72" stopOpacity="0"/><stop offset=".95" stopOpacity=".53"/><stop offset="1"/></radialGradient>
        <radialGradient id="edge-b" cx="-773.636" cy="746.715" r="143.24" gradientTransform="matrix(.15 -.9898 .8 .12 -410.718 -656.341)" gradientUnits="userSpaceOnUse"><stop offset=".76" stopOpacity="0"/><stop offset=".95" stopOpacity=".5"/><stop offset="1"/></radialGradient>
        <radialGradient id="edge-c" cx="230.593" cy="-106.038" r="202.43" gradientTransform="matrix(-.04 .9998 -2.1299 -.07998 -190.775 -191.635)" gradientUnits="userSpaceOnUse"><stop offset="0" stopColor="#35C1F1"/><stop offset=".11" stopColor="#34C1ED"/><stop offset=".23" stopColor="#2FC2DF"/><stop offset=".31" stopColor="#2BC3D2"/><stop offset=".67" stopColor="#36C752"/></radialGradient>
        <radialGradient id="edge-d" cx="536.357" cy="-117.703" r="97.34" gradientTransform="matrix(.28 .9598 -.78 .23 -1.928 -410.318)" gradientUnits="userSpaceOnUse"><stop offset="0" stopColor="#66EB6E"/><stop offset="1" stopColor="#66EB6E" stopOpacity="0"/></radialGradient>
        <linearGradient id="edge-e" x1="63.334" x2="241.617" y1="757.83" y2="757.83" gradientTransform="translate(-4.63 -580.81)" gradientUnits="userSpaceOnUse"><stop offset="0" stopColor="#0C59A4"/><stop offset="1" stopColor="#114A8B"/></linearGradient>
        <linearGradient id="edge-f" x1="157.401" x2="46.028" y1="680.556" y2="801.868" gradientTransform="translate(-4.63 -580.81)" gradientUnits="userSpaceOnUse"><stop offset="0" stopColor="#1B9DE2"/><stop offset=".16" stopColor="#1595DF"/><stop offset=".67" stopColor="#0680D7"/><stop offset="1" stopColor="#0078D4"/></linearGradient>
      </defs>
      <path fill="url(#edge-e)" d="M231 190.5c-3.4 1.8-6.9 3.4-10.5 4.7c-11.5 4.3-23.6 6.5-35.9 6.5c-47.3 0-88.5-32.5-88.5-74.3c.1-11.4 6.4-21.9 16.4-27.3c-42.8 1.8-53.8 46.4-53.8 72.5c0 73.9 68.1 81.4 82.8 81.4c7.9 0 19.8-2.3 27-4.6l1.3-.4c27.6-9.5 51-28.1 66.6-52.8c1.2-1.9.6-4.3-1.2-5.5c-1.3-.8-2.9-.9-4.2-.2"/>
      <path fill="url(#edge-a)" d="M231 190.5c-3.4 1.8-6.9 3.4-10.5 4.7c-11.5 4.3-23.6 6.5-35.9 6.5c-47.3 0-88.5-32.5-88.5-74.3c.1-11.4 6.4-21.9 16.4-27.3c-42.8 1.8-53.8 46.4-53.8 72.5c0 73.9 68.1 81.4 82.8 81.4c7.9 0 19.8-2.3 27-4.6l1.3-.4c27.6-9.5 51-28.1 66.6-52.8c1.2-1.9.6-4.3-1.2-5.5c-1.3-.8-2.9-.9-4.2-.2" opacity=".35"/>
      <path fill="url(#edge-f)" d="M105.7 241.4c-8.9-5.5-16.6-12.8-22.7-21.3c-26.3-36-18.4-86.5 17.6-112.8c3.8-2.7 7.7-5.2 11.9-7.2c3.1-1.5 8.4-4.1 15.5-4c10.1.1 19.6 4.9 25.7 13c4 5.4 6.3 11.9 6.4 18.7c0-.2 24.5-79.6-80-79.6c-43.9 0-80 41.7-80 78.2c-.2 19.3 4 38.5 12.1 56c27.6 58.8 94.8 87.6 156.4 67.1c-21.1 6.6-44.1 3.7-62.9-8.1"/>
      <path fill="url(#edge-b)" d="M105.7 241.4c-8.9-5.5-16.6-12.8-22.7-21.3c-26.3-36-18.4-86.5 17.6-112.8c3.8-2.7 7.7-5.2 11.9-7.2c3.1-1.5 8.4-4.1 15.5-4c10.1.1 19.6 4.9 25.7 13c4 5.4 6.3 11.9 6.4 18.7c0-.2 24.5-79.6-80-79.6c-43.9 0-80 41.7-80 78.2c-.2 19.3 4 38.5 12.1 56c27.6 58.8 94.8 87.6 156.4 67.1c-21.1 6.6-44.1 3.7-62.9-8.1" opacity=".41"/>
      ...
      <path fill="url(#edge-d)" d="M152.3 148.9c-.8 1-3.3 2.5-3.3 5.7c0 2.6 1.7 5.1 4.7 7.2c14.4 10 41.5 8.7 41.6 8.7c10.7 0 21.1-2.9 30.3-8.3c18.8-11 30.4-31.1 30.4-52.9c.3-22.4-8-37.3-11.3-43.9C223.5 23.9 177.7 0 128 0C58 0 1 56.2 0 126.2c.5-36.5 36.8-66 80-66c3.5 0 23.5.3 42 10.1c16.3 8.6 24.9 18.9 30.8 29.2c6.2 10.7 7.3 24.1 7.3 29.5c0 5.3-2.7 13.3-7.8 19.9"/>
    </svg>
  )
}
...
function BraveIcon({ className }: { className?: string }) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 256 301" className={className}>
      <defs>
        <linearGradient id="brave-a" x1="0%" x2="100.097%" y1="50.018%" y2="50.018%"><stop offset="0%" stopColor="#FFF"/><stop offset="14.13%" stopColor="#FFF" stopOpacity=".958"/><stop offset="100%" stopColor="#FFF" stopOpacity=".7"/></linearGradient>
        <linearGradient id="brave-b" x1="-.039%" x2="100%" y1="49.982%" y2="49.982%"><stop offset="0%" stopColor="#F1F1F2"/><stop offset="9.191%" stopColor="#E4E5E6"/><stop offset="23.57%" stopColor="#D9DADB"/><stop offset="43.8%" stopColor="#D2D4D5"/><stop offset="100%" stopColor="#D0D2D3"/></linearGradient>
      </defs>
      <path fill="#F15A22" d="M256 97.1L246.7 72l6.4-14.4c.8-1.9.4-4-1-5.5l-17.5-17.7c-7.7-7.7-19.1-10.4-29.4-6.8l-4.9 1.7l-26.8-29l-45.3-.3h-.3L82.3.4L55.6 29.6l-4.8-1.7c-10.4-3.7-21.9-1-29.6 6.9l-17.8 18c-1.2 1.2-1.5 2.9-.9 4.4l6.7 15L0 97.3L6 120l27.2 103.3c3.1 11.9 10.3 22.3 20.4 29.5c0 0 33 23.3 65.5 44.4c2.9 1.9 5.9 3.2 9.1 3.2s6.2-1.3 9.1-3.2c36.6-24 65.5-44.5 65.5-44.5c10-7.2 17.2-17.6 20.3-29.5l27-103.3z"/>
      <path fill="url(#brave-a)" d="M34.5 227.7L0 99.5l10.1-25.1l-7-18.6l16.7-17c5.5-4.9 16.3-6.6 21.3-3.7l26.1 15l34 7.9l26.5-11l2.2 227.7c-.4 32.8 1.7 29.3-22.4 13.8L48 248.6c-6.4-6.1-11.3-13-13.5-20.9" opacity=".15"/>
      <path fill="url(#brave-b)" d="m202.2 252.246l-50.6 34.6c-14.1 7.7-20.9 15.3-22 11.6c-.9-2.9-.2-11.4-.5-24.6l-.6-222.7c.1-2.2 1.6-5.9 4.2-5.5l25.8 7.8l37.2-5.8l24.6-18.1c2.6-2 6.4-1.8 8.8.5l22 21c2 2.1 2.1 6.2.9 8.8l-6.1 11.3l10.1 26.1l-34.8 129.4c-5.4 16.1-13 20.3-19 25.6" opacity=".4"/>
...
function MediumIcon({ className }: { className?: string }) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" className={className}>
      <path fill="none" stroke="currentColor" strokeLinejoin="round" d="M8.5 14.5v-8M11 10l5 7.88m0-.001L22.5 6.5M8.5 21l-7-3.5V3l7 3.5L11 10l4.5-7l7 3.5V21l-14-6.75z"/>
    </svg>
  )
}
...
export function SourceIcon({ type, className = 'w-4 h-4' }: SourceIconProps) {
  if (!type) return <GlobeIcon className={className} />
  ...
  if (normalizedType === 'safari' || normalizedType.includes('safari')) {
    return <SafariIcon className={className} />
  }
  if (normalizedType === 'firefox' || normalizedType.includes('firefox')) {
    return <FirefoxIcon className={className} />
  }
  if (normalizedType === 'edge' || normalizedType.includes('edge')) {
    return <EdgeIcon className={className} />
  }
  if (normalizedType === 'brave' || normalizedType.includes('brave')) {
    return <BraveIcon className={className} />
  }
  if (normalizedType === 'google' || normalizedType.includes('google')) {
    return <GoogleIcon className={className} />
  }
  if (normalizedType === 'linkedin' || normalizedType.includes('linkedin')) {
    return <LinkedinIcon className={className} />
  }
  if (normalizedType === 'twitter' || normalizedType.includes('twitter') || normalizedType === 'x' || normalizedType.includes('x.com')) {
    return <XIcon className={className} />
  }
  if (normalizedType === 'github' || normalizedType.includes('github')) {
    return <GithubIcon className={className} />
  }
  if (normalizedType === 'reddit' || normalizedType.includes('reddit')) {
